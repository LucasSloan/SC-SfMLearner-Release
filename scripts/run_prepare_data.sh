...
DATASET="/mnt/Bulk Storage/kitti/odometry/data_odometry_color/dataset/"
TRAIN_SET="/mnt/Bulk Storage/kitti/kitti_vo_256/"
python data/prepare_train_data.py "$DATASET" --dataset-format 'kitti_odom' --dump-root "$TRAIN_SET" --width 832 --height 256 --num-threads 32